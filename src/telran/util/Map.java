...
public interface Map<K, V> {
	...
	default public V putIfAbsent(K key, V value) {
		...
		return res;
//		return res != null ? res : put(key, value);
	}
	/**
	 * 
	 * @param key
	 ...
	 * @param key
	 * @param value
	 * @return a value matching a given key or the given value 
	 * (second parameter) if no entry with the key
	 */
...
//		return res != null ? res : value;
	 ...
	 * 
	 * @param key
	 * @return true of there is an entry with a given key otherwise false
	 */
	boolean containsKey(K key);
	/**
	 * 
	 * @param value
	 * @return true of there is an entry with a given value otherwise false
	 */
	 ...
	 * @return either reference to value of removed entry (removed) 
	 * or null (not removed)
	 */
	V remove(K key);
